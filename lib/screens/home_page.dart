              ...
              children: List.generate(
                ...
                (index) => Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => DetailDestinasi(destination: popular[index]),),);
                    },
              ...
              child: Column(
                children: List.generate(
                  ...
                  (index) => Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => DetailDestinasi(destination: rekomendasi[index]),),);
                      },
